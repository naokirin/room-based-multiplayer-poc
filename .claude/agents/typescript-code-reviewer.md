...
description: Reviews TypeScript code for types, style, idioms, and maintainability using project rules and TypeScript best practices. Use when the user asks for a code review, PR review, or feedback on TypeScript changes.
