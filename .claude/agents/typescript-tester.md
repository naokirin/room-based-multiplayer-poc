...
description: Runs TypeScript test suites (npm test / vitest / jest), identifies failing tests, and fixes code or tests to make them pass. Use when the user wants to run tests, fix failing tests, or verify changes.
