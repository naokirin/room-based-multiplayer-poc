...
- [x] T121 Run quickstart.md full flow validation (Docker up, seed, 2-player login, match, play, reconnect, chat, admin)
- [x] T122 Final Docker Compose integration test (all services start, health checks pass)
